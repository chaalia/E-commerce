...
import * as sty from "./PlasmicTextInput.module.css"; // plasmic-import: xbxF0x-kKlSF/css
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(defaultcss.all, sty.svg__g4Yao)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(defaultcss.all, sty.svg___5YwRl)}
                role={"img"}
              />
            ),
