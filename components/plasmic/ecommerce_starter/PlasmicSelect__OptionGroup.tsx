...
import * as sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: ZY2BpC27U-_T/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: pdS8OvCxNCRU/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__xBqGz)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__a6LQm)}
              />
            </React.Fragment>
          ),
          value: args.children
